...
<a href="https://components.orama.com/?path=/story/components-searchbutton--search-button" target="_blank">Search Button</a> component is a simple button that can be used to toggle a [Search Box](/cloud/ui-components/search-box).
